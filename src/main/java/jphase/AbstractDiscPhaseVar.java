...
public abstract class AbstractDiscPhaseVar implements DiscPhaseVar {
	...
	/**
     * @see DiscPhaseVar#sumPH(DiscPhaseVar, DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#sumPH(DiscPhaseVar)
     */
	...
	/**
     * @see DiscPhaseVar#getMatrixArray()
     */
	...
	/**
     * @see DiscPhaseVar#getVectorArray()
     */
	...
	/**
     * @see DiscPhaseVar#expectedValue()
     */
    ...
    /**
     * @see DiscPhaseVar#cdf(int, double)
     */
	...
	/**
     * @see DiscPhaseVar#prob(double, double)
     */
	...
	/**
     * @see DiscPhaseVar#survival(double)
     */
	...
	/**
     * @see DiscPhaseVar#survival(int, double)
     */
	...
	/**
     * @see DiscPhaseVar#quantil(double)
     */
	...
	/**
     * @see DiscPhaseVar#sum(DiscPhaseVar, DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#sum(DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#sumGeom(double)
     */
	...
	/**
     * @see DiscPhaseVar#mix(double, DiscPhaseVar, DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#mix(double, DiscPhaseVar)
     */
	...
	/**
     * @see DiscPhaseVar#min(DiscPhaseVar, DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#min(DiscPhaseVar)
     */
	...
	/**
     * @see DiscPhaseVar#max(DiscPhaseVar, DiscPhaseVar)
     */
    ...
    /**
     * @see DiscPhaseVar#max(DiscPhaseVar)
     */
