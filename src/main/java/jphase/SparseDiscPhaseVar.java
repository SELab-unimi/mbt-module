...
public class SparseDiscPhaseVar extends AbstractDiscPhaseVar{
    ...
    /**
     * @see PhaseVar#setMatrix(no.uib.cipr.matrix.Matrix)
     */
    ...
    /**
     * @see PhaseVar#setVector(no.uib.cipr.matrix.Vector)
     */
