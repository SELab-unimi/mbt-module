    ...
    */
    public void displayVar(PhaseVarInfo info) {
            if (info != null) {
                ...
                param.setPreferredSize(new Dimension(Math.max(100 + info.var.getVectorArray().length*95,height), height));
                ...
                pdfPane.setPreferredSize(new Dimension(width, height));
                ...
                cdfPane.setPreferredSize(new Dimension(width, height));
