...
public abstract class AbstractContPhaseVar implements ContPhaseVar {
    ...
    /**
     * @see ContPhaseVar#sumPH(DiscPhaseVar,
     *      ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#getMatrixArray()
     */
    ...
    /**
     * @see ContPhaseVar#getVectorArray()
     */
    ...
    /**
     * @see ContPhaseVar#expectedValue()
     */
    ...
    /**
     * @see ContPhaseVar#cdf(int, double)
     */
    ...
    /**
     * @see ContPhaseVar#pdf(int, double)
     */
    ...
    /**
     * @see ContPhaseVar#prob(double, double)
     */
    ...
    /**
     * @see ContPhaseVar#survival(double)
     */
    ...
    /**
     * @see ContPhaseVar#survival(int, double)
     */
    ...
    /**
     * @see PhaseVar#lossFunction1(double)
     */
    ...
    /**
     * @see PhaseVar#lossFunction2(double)
     */
    ...
    /**
     * @see ContPhaseVar#quantil(double)
     */
    ...
    /**
     * @see ContPhaseVar#sum(ContPhaseVar, ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#sum(ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#sumGeom(double)
     */
    ...
    /**
     * @see ContPhaseVar#mix(double, ContPhaseVar, ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#mix(double, ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#min(ContPhaseVar, ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#min(ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#max(ContPhaseVar, ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#max(ContPhaseVar)
     */
    ...
    /**
     * @see ContPhaseVar#residualTime(double)
     */
    ...
    /**
     * @see ContPhaseVar#eqResidualTime()
     */
    ...
    /**
     * @see ContPhaseVar#waitingQ(double)
     */
    ...
    /**
     * @see ContPhaseVar#residualVar(double)
     */    
